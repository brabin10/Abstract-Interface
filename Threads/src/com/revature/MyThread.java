...
// Note that we could also implement the Runnable Interfce, but Thread extends that for us
public class MyThread extends Thread {
	...
	public void run() {
		...
		for (int i =0; i < 10; i++) {
			...
			// we have to use StringBuffer, because StringBuilder isn't thread safe.
